...
import webbrowser
from .config import THEMES, LINKS
...
def create_ui(app):
    ...
    # Stats
    app.stats = ttk.Label(main, text="Ready to crush tokens...", foreground=theme["accent_secondary"], font=("Consolas", 11, "bold"), background=theme["frame_bg"])
